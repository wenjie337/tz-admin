		...
		<section class="scrollable padder">
	        ...
	        <section class="panel panel-default">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" method="post" data-validate="parsley" action="sys/addSysMenu.htm">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="menuUrl" data-required="true">
                      </div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        ...
                        <div class="radio">
                          <label class="radio-custom">
                            <input type="radio" name="menuType" value="0" checked>
                            <i class="fa fa-circle-o"></i>
                            	请求地址
                          </label>
                        </div>
                      ...
                      <div class="col-sm-6">
                        <div class="radio">
                          <label class="radio-custom">
                            <input type="radio" name="expand" value="0" checked>
                            <i class="fa fa-circle-o"></i>
                            	否
                          </label>
                        </div>
                        <div class="radio">
                          <label class="radio-custom">
                            <input type="radio" name="expand" value="1" >
                            <i class="fa fa-circle-o"></i>
                            	是
                          </label>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="menuIndex" value="0">
                      </div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <select name="parentId" class="form-control m-b" onchange="setTreeCode(this)"> 
                          ...
                          [#if menus?exists]
                          	[#list menus as menu]
                          		[#if menu.menuType>0]
                          		<option value='${menu.id}'>${menu.menuName}(${menu.treeCode})</option>
                          		[/#if]
                          	[/#list]
                          [/#if]
                        </select>
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="idTreeCode" name="treeCode" value="">
                      </div>
                    </div>
